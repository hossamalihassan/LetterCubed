<?php 
    ...
    if(isset($_POST["signup_submit"])) {
        ...
        $search_if_email_exists = get_from_db("user_email", "users", "user_email", $signup_email, $conn);
        $search_if_username_exists = get_from_db("user_username", "users", "user_username", $signup_username, $conn);
